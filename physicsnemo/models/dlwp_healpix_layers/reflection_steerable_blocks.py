...
class ReflectionSteerableSymmetricConvNeXtBlock(nn.Module):
    """SymmetricConvNeXt with ReflectionSteerable convolutions and unified tanh."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.cln_enabled = False  # v1: no CLN
        ...
        self.layers = nn.ModuleList(
            [
                ...
                ParitySplitActivation(int(latent_channels), odd_fraction, _act(), _act(), unified=True),
                ...
                ParitySplitActivation(up_ch, odd_fraction, _act(), _act(), unified=True),
                _ReflectionSteerableConv1x1Wrap(
                    up_ch,
                    int(latent_channels),
                    odd_fraction=odd_fraction,
